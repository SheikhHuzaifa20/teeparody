...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'product_attributes.*.value'             => 'required_with:product_attributes|numeric|exists:attributes_values,id',
            'product_attributes.*.price'             => 'nullable|numeric|min:0',
            'product_attributes.*.qty'               => 'nullable|integer|min:0',
            'product_attributes.*.image'             => 'nullable|mimes:jpg,jpeg,png,webp|max:5120',
            'product_attributes.*.existing_image'    => 'nullable|string',
