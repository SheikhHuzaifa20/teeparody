...
Route::get('shipping-and-return-policy','HomeController@return_policy')->name('return_policy');
...
// AJAX Side Cart Routes
Route::post('/cart/add', [App\Http\Controllers\CartController::class, 'addToCart'])->name('cart.add');
Route::post('/cart/remove', [App\Http\Controllers\CartController::class, 'removeFromCart'])->name('cart.remove');
Route::post('/cart/update-qty', [App\Http\Controllers\CartController::class, 'updateQuantity'])->name('cart.update_qty');
Route::get('/cart/drawer-content', [App\Http\Controllers\CartController::class, 'getDrawerContent'])->name('cart.drawer_content');
...
Route::middleware(['auth', 'role:1']) // Only super_admin (role 1) can access /admin
    ->prefix('admin')
    ->group(function () {
