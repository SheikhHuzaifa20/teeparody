...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Trashed Faqs</h3>
    </div>
    <div class="content-header-right col-md-6 col-12">
        <div class="btn-group float-md-right">
            ...
            <a class="btn btn-info mb-1" href="{{ route('admin.faq.index') }}">Back to Active Faqs</a>
        </div>
    </div>
</div>
...
CRUDManager.init({
    ...
    entity: 'faq',
    routes: {
        data: "{{ route('admin.faq.trash.data') }}",
        restore: "{{ route('admin.faq.restore', ':id') }}",
        forceDelete: "{{ route('admin.faq.forceDelete', ':id') }}",
