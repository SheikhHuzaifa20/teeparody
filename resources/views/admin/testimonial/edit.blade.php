                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" required name="title" type="text"
                                                        id="title" value="{{ $testimonial->title }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="rating" id="rating" class="form-control" required>
                                                        ...
                                                        <option value="2"
                                                            {{ $testimonial->rating == 2 ? 'selected' : '' }}>★★☆☆☆ (2
                                                            Stars)</option>
                                                        <option value="3"
                                                            {{ $testimonial->rating == 3 ? 'selected' : '' }}>★★★☆☆ (3
                                                            Stars)</option>
                                                        <option value="4"
                                                            {{ $testimonial->rating == 4 ? 'selected' : '' }}>★★★★☆ (4
                                                            Stars)</option>
                                                        <option value="5"
                                                            {{ $testimonial->rating == 5 ? 'selected' : '' }}>★★★★★ (5
                                                            Stars)</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ asset($testimonial->image) }}" class="d-block"
                                                        alt="" width="100%">
                                                    <br>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="text2" type="text"
                                                        id="text2" value="{{ $testimonial->text2 }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
