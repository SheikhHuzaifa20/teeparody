        ...
        <div class="col-12">
            ...
            <div class="col-md-7 col-lg-7 col-sm-7 col-xs-12">
                ...
                <form action="{{route('order.place')}}" method="POST" id="order-place">
                    ...
                    @else
                    <a href="{{ url('signin') }}" class="btn btn-outline-primary mb-3">Returning customer? Click here to login</a>
                    <div class="form-group mb-3">
                    ...
                    @if(!Auth::check())
                    <div class="form-group mb-3"> <label class="chkbox">
            ...
            <div class="col-md-5 col-lg-5 col-sm-5 col-xs-12">
                ...
                <div class="YouOrder">
                    ...
                    @endphp
                    <h5>{{ $value['name'] }} x {{ $value['qty'] }} <span class="float-right">${{ number_format($itemBasePrice * $value['qty'], 2) }}</span></h5>
                      ...
                      <div class="card-body">
                        <div class="stripe-form-wrapper require-validation" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" data-cc-on-file="false">
                          ...
                          <div class="form-group">
                            <button class="btn btn-stripe-pay btn-block" type="button" id="stripe-submit">Pay Now ${{ number_format($subtotal + $variation, 2) }}</button>
                          </div>
                        </div>
                      </div>
                    </div>
