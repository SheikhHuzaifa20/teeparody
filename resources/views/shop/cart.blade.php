                                ...
                                <tbody>
                                    ...
                                    @foreach ($cart as $key => $value)
                                        @php
                                            ...
                                            $variationsList = $value['variation'] ?? [];
                                        @endphp
                                        <?php
                                        if ($key == 'shipping') {
                                            //continue;
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-3 no-margin">
                                                        <img src="{{ asset($prod_image->image ?? $value['image']) }}" alt=""
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        @if(!empty($value['attributes']))
                                                            <p class="m-0 text-muted small">{{ $value['attributes'] }}</p>
                                                        @endif
                                                        @foreach ($variationsList as $key => $values)
                                            ...
                                            <td>
                                                <h4>${{ number_format($itemBasePrice, 2) }}</h4>
                                            </td>
                                            <td>
                                                <h4>${{ number_format($itemBasePrice * $value['qty'] + $itemVarPrice, 2) }}
                                                </h4>
                                            </td>
                                            <td>
